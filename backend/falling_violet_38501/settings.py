"""
Django settings for falling_violet_38501 project.
...
ROOT_URLCONF = 'falling_violet_38501.urls'
...
WSGI_APPLICATION = 'falling_violet_38501.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_violet_38501 API",
    "DESCRIPTION": "API documentation for falling_violet_38501 App",
    "VERSION": "v1",
}
